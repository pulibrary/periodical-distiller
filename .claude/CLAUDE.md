...
See `docs/forum.org` for the project's deliberative record — decisions,
analysis, and open questions shared among Cliff, Claude Chat, and Claude
Code.  Follow the protocol in `.claude/collaboration-protocol.org`.
...
# Specify output directory pdm run python -m periodical_distiller.cli
harvest-pip --date 2026-01-29 --output ./my-pips ``` ## Interaction
conventions We have established a [collaboration
protocol](./collaboration-protocol.org) to facilitate collaboration
among three participants on a shared codebase. Read
[forum.org](../docs/forum.org) when starting a session about this
project.
