  ...
  - src
    ...
    - periodical_distiller
      ...
      - compilers
        ...
        - compiler.py
        - mets_compiler.py
        - veridian_sip_compiler.py
      - pipeline                  # Kanban-style pipeline orchestration
        - __init__.py
        - plumbing.py             # Token, Pipe, Bucket, Filter base class
        - orchestrator.py         # Coordinates filters via config
        - filters                 # Pipeline stages (token handling)
          - __init__.py
          - harvest_filter.py     # Uses CeoClient
          - html_filter.py        # Uses HtmlTransformer
          - pdf_filter.py         # Uses PdfTransformer
          - alto_filter.py        # Uses AltoTransformer
          - mods_filter.py        # Uses ModsTransformer
          - collection_filter.py  # Polls for completed articles
          - mets_filter.py        # Uses MetsCompiler
          - validation_filter.py  # Uses LOC schemas
          - packaging_filter.py   # Assembles final SIP
      - orchestrators             # (legacy, to be replaced by pipeline)
        - __init__.py
      - validators
        - __init__.py
      - cli.py
